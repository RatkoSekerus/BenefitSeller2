...
namespace BenefitSeller.API.Migrations
{
    ...
    [Migration("20240520222442_add subscriptionPlan data")]
    partial class addsubscriptionPlandata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BenefitSeller.API.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f13ac76c-30ec-4365-9830-9d059216fa8c"),
                            Name = "Standard Plan",
                            SubscriptionType = 0
                        },
                        new
                        {
                            Id = new Guid("7793fed3-a63a-4912-b47b-fa5e6fba1ffe"),
                            Name = "Premium Plan",
                            SubscriptionType = 1
                        },
                        new
                        {
                            Id = new Guid("29d4378b-e387-41f2-97b2-fcdcde2eb693"),
                            Name = "Platinum Plan",
                            SubscriptionType = 2
                        });
                });
            ...
            modelBuilder.Entity("BenefitSeller.API.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 21, 0, 24, 41, 666, DateTimeKind.Local).AddTicks(2810));
