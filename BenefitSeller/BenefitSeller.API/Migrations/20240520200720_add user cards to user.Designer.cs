...
namespace BenefitSeller.API.Migrations
{
    ...
    [Migration("20240520200720_add user cards to user")]
    partial class addusercardstouser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BenefitSeller.API.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 20, 22, 7, 20, 236, DateTimeKind.Local).AddTicks(7343));
